        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link href="/" className="inline-block mb-4">
              ...
              <span className="text-xl font-light ml-1">Hotel</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">123 Galle Road, Colombo, Sri Lanka</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">info@hashehotel.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <button className="px-3 py-2 rounded-r-md bg-amber-600 text-white text-sm">Subscribe</button>
            </div>
          </div>
        </div>

        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} HASHE Hotel. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
